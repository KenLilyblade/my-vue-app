module.exports = {
    ...
    // 继承规则
    extends: ['plugin:vue/vue3-essential', 'eslint:recommended', '.eslintrc-auto-import.json', 'plugin:@typescript-eslint/recommended',],
    ...
    rules: {
        ...
        'vue/no-use-v-if-with-v-for': [
            // 不允许vforvif同级，vue2vfor比vif高，vue3相反
            'error',
            {
        ...
        // 'no-unreachable': 0, // 不允许可达代码return，throw，continue，和break语句后面还有语句。
